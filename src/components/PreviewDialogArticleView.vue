<template>
  <!-- @/components/ReseasrchItemView.vue from icjia-data-portal-proto -->
  <div>
    <v-img height="500px" :src="article.image.url"> </v-img>
        ...
        <v-flex xs12 sm10 md8>
          <v-layout align-center justify-space-between row>
            <div class="article-header">
              <span v-for="(type, i) in article.type" :key="i">
                {{ type }}
              </span>
              &nbsp;|&nbsp;
